...
export const tools: ToolItem[] = [
  { name: 'Java', short: 'Java', group: 'Language', accent: 'from-orange-500/30 to-amber-300/20' },
  { name: 'Python', short: 'Py', group: 'Language', accent: 'from-blue-500/30 to-yellow-300/20' },
  { name: 'JavaScript', short: 'JS', group: 'Language', accent: 'from-yellow-400/35 to-amber-200/20' },
  { name: 'TypeScript', short: 'TS', group: 'Language', accent: 'from-sky-500/35 to-blue-300/20' },
  { name: 'React', short: 'React', group: 'Frontend', accent: 'from-cyan-400/35 to-sky-300/20' },
  { name: 'Next.js', short: 'Next', group: 'Frontend', accent: 'from-slate-200/20 to-slate-500/10' },
  { name: 'Node.js', short: 'Node', group: 'Backend', accent: 'from-lime-400/30 to-green-300/20' },
  { name: 'Spring', short: 'Spring', group: 'Backend', accent: 'from-green-500/30 to-lime-300/20' },
  { name: 'PHP', short: 'PHP', group: 'Backend', accent: 'from-indigo-400/30 to-slate-300/20' },
  { name: 'Docker', short: 'Docker', group: 'DevOps', accent: 'from-sky-500/35 to-cyan-300/20' },
  { name: 'PostgreSQL', short: 'Postgres', group: 'Database', accent: 'from-blue-400/35 to-slate-300/20' },
  { name: 'MySQL', short: 'MySQL', group: 'Database', accent: 'from-slate-400/20 to-blue-300/20' },
  { name: 'MongoDB', short: 'Mongo', group: 'Database', accent: 'from-emerald-500/30 to-green-300/20' },
  { name: 'Linux', short: 'Linux', group: 'Platform', accent: 'from-slate-100/15 to-amber-200/15' },
  { name: 'Git', short: 'Git', group: 'Versioning', accent: 'from-orange-500/35 to-red-300/20' },
  { name: 'Postman', short: 'API', group: 'Tooling', accent: 'from-orange-400/35 to-amber-200/15' },
  { name: 'Nginx', short: 'Nginx', group: 'Server', accent: 'from-emerald-500/35 to-green-300/20' },
  { name: 'AWS', short: 'AWS', group: 'Cloud', accent: 'from-amber-500/25 to-slate-200/15' },
  { name: 'Firebase', short: 'Firebase', group: 'Cloud', accent: 'from-yellow-500/35 to-orange-300/15' },
  { name: 'Microsoft Access', short: 'Access', group: 'Systems', accent: 'from-rose-500/30 to-red-300/15' },
  { name: 'VBA', short: 'VBA', group: 'Automation', accent: 'from-fuchsia-500/25 to-violet-300/15' },
  { name: 'SQL', short: 'SQL', group: 'Database', accent: 'from-cyan-400/25 to-sky-300/15' },
]
